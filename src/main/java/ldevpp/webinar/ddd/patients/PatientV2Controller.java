...
public class PatientV2Controller {
    ...
    @RequestMapping(path = "/v2/patients", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(path = "/v2/patients/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
